      ...
      <?php
         ...
         echo '<div class="relative min-h-screen flex">';
            ...
            echo '<div class="flex-1 m-8 p-10 bg-blue-50 shadow-lg rounded text-gray-800" id="content">';
               echo '<h1 class="text-xl font-semibold pb-10">Delete a Person</h1>';
               if(isset($_COOKIE["username"])) {
                  echo '<form class="bg-blue-100 shadow-md px-8 pt-6 pb-8 mb-4" action="delete_person_sql.php" method=post>';
                  ...
                  if($result->num_rows != 0) {
                     echo '<label class="block text-gray-700 mb-2 font-medium" for="id">Select Person to Delete from Database:</label>';
                     echo '<select class="rounded w-full py-2 px-2" name="id">'; 
                     ...
                     echo "<p class=\"text-xl font-semibold\">There Are No People In This Library</p>"; 
                  }
                  echo "</form>";
               } else {
