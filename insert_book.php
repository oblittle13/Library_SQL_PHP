...
<div class="relative min-h-screen flex">
    ...
    <div class="flex-1 m-8 p-10 bg-blue-50 drop-shadow-xl rounded-md text-gray-800" id="content">
        ...
        <h1 class="text-xl font-semibold pb-10">Insert a Book</h1>

        <form class="rounded-lg bg-blue-100 shadow-md px-8 pt-6 pb-8 mb-4" action="insert_book_sql.php" method=post>
            <div class="mb-6">
	    ...
	    <div class="mb-6">
                <label class="block text-gray-700 mb-2 font-medium" for="genre">
                Genre Type:
                </label>
                <input class="rounded py-2 px-2 w-full" type=text name="genre">
            </div>
	    <div class="mb-6">
