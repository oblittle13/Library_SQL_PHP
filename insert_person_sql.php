...
echo '<div class="relative min-h-screen flex">';
   ...
   echo '<div class="flex-1 m-8 p-10 bg-blue-50 shadow-lg rounded text-gray-800" id="content">';
      ...
      if (isset($_COOKIE["username"])) { 
         ...
         $sql = "insert into PERSON (firstname, lastname, address, dob, email, lib_name) values ('$_POST[firstname]','$_POST[lastname]','$_POST[address]','$_POST[dob]','$_POST[email]','$_POST[lname]')"; 
         if($conn->query($sql))  
         { 
            echo '<h3 class="text-xl font-semibold pb-10">';
               echo "Person was added!";
            echo '</h3>';
