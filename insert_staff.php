...
<html lang="en">
   <head>
      ...
      <title>Insert a Staff member</title>
      ...
      <?php
         ...
         echo '<div class="relative min-h-screen flex">';
            ...
            echo '<div class="flex-1 m-8 p-10 bg-blue-50 shadow-lg rounded text-gray-800" id="content">
               <h1 class="text-xl font-semibold pb-10">Add a new Staff Member</h1>';
               if (isset($_COOKIE["username"])) {
                  echo '<form class="rounded-lg bg-blue-100 shadow-md px-8 pt-6 pb-8 mb-4" action="insert_staff_sql.php" method=post>';
                     ...
                     if($result->num_rows != 0) {
                        echo '<div class="mb-6">
                           <label class="block text-gray-700 mb-2 font-medium" for="p_id">Person ID:</label>
