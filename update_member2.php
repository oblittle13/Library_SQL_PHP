            ...
            echo '<div class="relative min-h-screen flex">';
                ...
                echo '<div class="flex-1 m-8 p-10 bg-blue-50 shadow-lg rounded text-gray-800" id="content">';    
                    ...
                    if(isset($_COOKIE["username"])){
                        echo "<form class=\"bg-blue-100 shadow-md px-8 pt-6 pb-8 mb-4\" action=\"update_member_sql.php\" method=post>";
                            ...
                            $sql = "SELECT *
                                    FROM MEMBER, PERSON
                                    WHERE member_id='$_POST[member_id]' AND p_id = id";
                            ...
                            if($result->num_rows!= 0){
                                ...
                                echo '</div>';                                
                                echo '<div class="mb-6">';
                                    echo "<label class=\"block text-gray-700 mb-2 font-medium\" for=\"member_id\">Current ID:$rec[member_id]</label>";
                                    echo "<input class=\"rounded py-2 px-2 w-full\" type=\"textl\" name=\"member_id\" value=\"$rec[member_id]\">";
                                echo '</div>';

                                echo "<input type=hidden name=\"oldid\" value=\"$_POST[member_id]\">";
