        ...
        <?php
            ...
            echo '<div class="relative min-h-screen flex">';
                ...
                echo '<div class="flex-1 m-8 p-10 bg-blue-50 shadow-lg rounded text-gray-800" id="content">';
                    echo '<h1 class="text-xl font-semibold pb-10">Update a Staff member</h1>';
                    if(isset($_COOKIE["username"])){
                        echo '<form class="bg-blue-100 shadow-md px-8 pt-6 pb-8 mb-4" action="update_staff2.php" method=post>';
                            ...
                            {
                                echo '<label class="block text-gray-700 mb-2 font-medium" for="staff_id">Person Name:</label>';
